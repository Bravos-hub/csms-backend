...
async function ensureEvzoneOrganization(client: PrismaClient) {
...
async function main() {
  ...
  const africa = await prisma.geographicZone.upsert({
    where: { code: 'AF' },
    update: { name: 'Africa', type: ZoneType.CONTINENT, isActive: true },
    create: {
      name: 'Africa',
      code: 'AF',
  ...
  const europe = await prisma.geographicZone.upsert({
    where: { code: 'EU' },
    update: { name: 'Europe', type: ZoneType.CONTINENT, isActive: true },
    create: {
      name: 'Europe',
      code: 'EU',
      type: ZoneType.CONTINENT,
  ...
  await prisma.tenantApplication.upsert({
    ...
    create: {
      ...
      businessPlanSummary:
        'We plan to install 10 fast chargers to serve the CBD area with 24/7 operations.',
      sustainabilityCommitments:
        'All energy will be sourced from renewable sources',
  ...
  await prisma.tenantApplication.upsert({
    ...
    create: {
      ...
      businessPlanSummary:
        'Operate premium charging facility with customer lounge',
      proposedRent: 1500,
      proposedTerm: 36,
      ...
      responseMessage:
        'We are pleased to approve your application. Please review the proposed terms.',
  ...
  await prisma.subscriptionPlan.upsert({
    ...
    create: {
      ...
      name: 'Starter',
      description:
        'Perfect for getting started with your first charging station',
      role: 'STATION_OWNER',
      price: 0,
      currency: 'UGX',
      ...
      features: {
        create: [
          {
            featureKey: 'CAPACITY',
            featureValue: 'Up to 5 chargers',
            order: 1,
          },
          {
            featureKey: 'ANALYTICS',
            featureValue: 'Basic reporting',
            order: 2,
          },
    ...
    create: {
      ...
      features: {
        create: [
          {
            featureKey: 'CAPACITY',
            featureValue: 'Up to 25 chargers',
            order: 1,
          },
          ...
          {
            featureKey: 'ANALYTICS',
            featureValue: 'Advanced analytics',
            order: 4,
          },
        ],
      },
        ...
        create: [
          {
            resource: 'stations',
            action: 'read',
            description: 'scope: own, limit: 25',
          },
          {
            resource: 'stations',
            action: 'create',
        ...
        create: [
          {
            resource: 'stations',
            action: 'read',
            description: 'scope: assigned, limit: 3',
          },
          {
            resource: 'sessions',
            action: 'read',
    ...
    create: {
      ...
      features: {
        create: [
          {
            featureKey: 'CAPACITY',
            featureValue: 'Unlimited stations',
            order: 1,
          },
    ...
    create: {
      ...
      features: {
        create: [
          {
            featureKey: 'FEATURES',
            featureValue: 'Public marketplace',
            order: 1,
          },
          {
            featureKey: 'FEATURES',
            featureValue: 'Job notifications',
            order: 2,
          },
        ],
      },
    ...
    create: {
      ...
      features: {
        create: [
          {
            featureKey: 'FEATURES',
            featureValue: 'Priority job matching',
            order: 1,
          },
          {
            featureKey: 'FEATURES',
            featureValue: 'Certification showcase',
            order: 2,
          },
          {
            featureKey: 'ANALYTICS',
            featureValue: 'Analytics dashboard',
            order: 3,
          },
        ],
      },
    ...
    create: {
      ...
      features: {
        create: [
          {
            featureKey: 'CAPACITY',
            featureValue: 'List up to 3 sites',
            order: 1,
          },
          {
            featureKey: 'FEATURES',
            featureValue: 'Standard listing',
            order: 2,
          },
        ],
      },
    ...
    create: {
      ...
      features: {
        create: [
          ...
          {
            featureKey: 'FEATURES',
            featureValue: 'Featured listings',
            order: 2,
          },
          {
            featureKey: 'ANALYTICS',
            featureValue: 'Revenue analytics',
            order: 3,
          },
          { featureKey: 'SUPPORT', featureValue: 'Priority support', order: 4 },
        ],
  ...
  await prisma.providerDocument.upsert({
    ...
    update: {
      ...
      fileUrl:
        'https://example.com/provider-docs/technical-conformance-pack.pdf',
  ...
  await prisma.providerDocument.upsert({
    ...
    update: {
      ...
      fileUrl:
        'https://example.com/provider-docs/insurance-certificate-2026.pdf',
